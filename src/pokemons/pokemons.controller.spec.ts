...
describe('PokemonsController', () => {
  ...
  it('should have called the service with the correct id and data (update)', async() => {
    ...
    const updatedPokemon = await controller.update(id, dto)

    expect(updatedPokemon).toBe("")
  ...
  it('should have called delete with the correct id (delete)', async() => {
    ...
    const id = '2';
    const deletedPokemon = await controller.remove(id);

    expect(deletedPokemon).toBe("")
  })
});
